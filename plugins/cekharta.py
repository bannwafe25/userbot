...
async def _(client, message, *args):
    ...
    if user:
        ...
        kerj = random.choice(PEKERJAAN_LIST)

        response = f"""
<blockquote expandable>**__{dtk} **Deteksi Harta** {dtk}
...
"""
        ...
        await message.reply_text("<blockquote>{em.gagal} **Gagal mendeteksi pengguna...**</blockquote>")
