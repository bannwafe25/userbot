...
API_KEY = "sk_ms_2e9541fd10b7f6f7a7e6c5ac24aa4d407c4ea02fa1a58854"
...
async def ai_response(client: Client, message: Message):
    if not message.text:
        return
    ...
    try:
        ...
        await message.reply_text("berisik anjg")
